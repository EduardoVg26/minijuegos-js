var all_questions = {
  question_string: "¿Qué resultado no da 20?",
  choices: {
    correct: "2+18",
    wrong: ["15+6", "12+6"],
  },
...
//?question={"question_string":"What%20color%20is%20the%20sky?","choices":{"correct":"Blue","wrong":["Pink","Orange","Green","Red","Black"]}}
...
Quiz.prototype.render = function (container) {
  ...
  question_container.bind("user-select-change", function () {
    if (self.question.user_choice_index == self.question.correct_choice_index) {
      ...
      // $("#choices-" + self.question.correct_choice_index + " + label").css(
      //   "background-color",
      //   "#e74c3c"
      // );
      // $("#choices-" + self.question.correct_choice_index + " + label").css(
...
Question.prototype.render = function (container) {
  ...
  var divImg = $("<div>").attr("id", "pistola").appendTo(container);
  var img = $(document.createElement("img"))
    .attr("src", "pistola.png")
    .appendTo(divImg);
...
$(document).ready(function () {
  ...
  var quiz = new Quiz("ELIMINA EL INCORRECTO");
  var data = getData();
  if (data != null) {
