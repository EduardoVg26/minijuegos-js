...
var arrayPosition = [
  ...
  [finishUpRightX, finishUpRightY, [15, 0]],
  [finishDownX, finishDownY, [15, 10]],
];
...
function drawPlayer(position) {
  ...
  game.font = "bold 23px arial";
  game.strokeText(
    incorrecto[0],
    arrayPosition[0][0] + 11,
    arrayPosition[0][1] + 25
  );
  game.fill();
  ...
  game.strokeText(
    incorrecto[1],
    arrayPosition[1][0] + 12,
    arrayPosition[1][1] + 26
  );
  game.fill();
  ...
  game.strokeStyle = "white";
  game.font = "bold 23px arial";
  game.strokeText(correcto, arrayPosition[2][0] + 10, arrayPosition[2][1] + 28);
  game.fill();
