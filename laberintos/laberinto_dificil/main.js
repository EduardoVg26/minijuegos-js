...
var arrayPosition = [
  ...
  [finishUpRightX, finishUpRightY, [19, 0]],
  [finishDownX, finishDownY, [19, 13]],
];
...
function drawPlayer(position) {
  ...
  game.font = "bold 22px arial";
  game.strokeText(
    incorrecto[0],
    arrayPosition[0][0] + 7,
    arrayPosition[0][1] + 19
  );
  game.fill();
  ...
  game.strokeStyle = "white";
  game.font = "bold 22px arial";
  game.strokeText(correcto, arrayPosition[2][0] + 7, arrayPosition[2][1] + 20);
  game.fill();
